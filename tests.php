		...
		<div class="row">
			<div class="col-md-12">
				<div class="col-md-4 col-md-offset-4 text-center">			
					...
					<thead><tr><th class='col-md-1 text-center' >Lección</th><th class='col-md-2 text-center'>Nombre</th><th class='col-md-5 text-center'>Descripción</th><th class='col-md-2 text-center'>Nivel</th><th class='col-md-2 text-center'>--</th></tr></thead>
		 			<tbody>
		 			<?php 
