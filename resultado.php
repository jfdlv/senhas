	...
	<div class="row">
		<div class="col-md-12 col-md-offset-1">
			<h2>Usted obtuvo el siguiente puntaje:</h2>
		</div>
	</div>
	<div class="row">
		<div class="col-md-6 col-md-offset-3 text-center well">
			<h1><?php echo $_SESSION['puntaje'] ?>%</h1>
			<?php if(!isset($_SESSION['usuario'])){echo "<p class='importante'>Para que su puntaje se almacene y se genere estadisticas con este usted debe poseer una cuenta</p>";} ?>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12 text-center">
				<a href="tests.php" class="btn btn-primary">Volver a los test</a>
